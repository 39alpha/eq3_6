      subroutine rd3ind(cgexj,cgexpi,covali,ehi,egexsi,fo2lgi,iebal3,
...
c     format.
c
c     This subroutine is a near-clone of XCON3/rd3d8.f. The present
...
c     ending messages. To maintain close consistency with XCON3/rd3d8.f,
...
c     EQ3NR/rd3inw.f, XCON3/rd3d8.f, and XCON3/rd3w8.f.
c
...
c
      integer ilnobl
c
      logical qgexbf,qgexbs,qgexef,qgexrd,qmark,qnone,qnonei,qnonep,
     $ qnones,qnoner,qokay,qstop
c
      character(len=nlchpa) ufield(nfldpa)
      character(len=nlchpa) uline1,uline2,ulscr
      character(len=nlchpa) uheadr,uheadx
c
      character(len=80) ustr
      character(len=80) ux80
      character(len=48) ux48
      character(len=24) ustr24,ustrn
      character(len=1) ux1
c
      real(8) var
c
...
c
 ...
 3000   format(/' * Error - (EQ3NR/rd3ind) The dimensioning parameter',
...
c
 ...
 3010   format(/' * Error - (EQ3NR/rd3ind) The dimensioning parameter',
...
c
 ...
 3020   format(/' * Error - (EQ3NR/rd3ind) The dimensioning parameter',
...
c
 ...
 3030   format(/' * Error - (EQ3NR/rd3ind) The dimensioning parameter',
...
c
 ...
 1010   format(/' * Error - (EQ3NR/rd3ind) The first line of a "D"',
...
c
 ...
 1015     format(/' * Error - (EQ3NR/rd3ind) Have too many lines in',
...
c
 ...
 1020   format(/' * Error - (EQ3NR/rd3ind) Was expecting to find a',
 ...
 1022   format(/' * Error - (EQ3NR/rd3ind) Was expecting to find an',
...
c
      if (icount .eq. 0) then
        write (noutpt,1024)
        write (nttyo,1024)
 1024   format(/' * Note - (EQ3NR/rd3ind) No option was selected for',
     ...
     $  ' accord with the',/7x,'data file reference pressure curve.')
      ...
      elseif (icount .gt. 1) then
        write (noutpt,1026)
        write (nttyo,1026)
 1026   format(/' * Warning - (EQ3NR/rd3ind) Multiple options were',
...
c
      if (icount .eq. 0) then
        write (noutpt,1034)
        write (nttyo,1034)
 1034   format(/' * Note - (EQ3NR/rd3ind) No option was selected',
 ...
 1036   format(/' * Warning - (EQ3NR/rd3ind) Multiple options were',
...
c
      if (icount .eq. 0) then
        write (noutpt,1044)
        write (nttyo,1044)
 1044   format(/' * Note - (EQ3NR/rd3ind) No electrical balancing',
     $  ' option was',/7x,'selected. No balancing will be done.')
      ...
      elseif (icount .gt. 1) then
        write (noutpt,1046)
        write (nttyo,1046)
 1046   format(/' * Warning - (EQ3NR/rd3ind) Multiple electrical',
...
c
 ...
 1047   format(/' * Note - (EQ3NR/rd3ind) No default redox constraint',
     ...
     $  g12.5,' (log bars) will be used.')
      ...
      elseif (icount .gt. 1) then
        write (noutpt,1048)
        write (nttyo,1048)
 1048   format(/' * Warning - (EQ3NR/rd3ind) Multiple default redox',
...
c
 ...
 1030   format(/' * Warning - (EQ3NR/rd3ind) Found ',i2,' fields',
...
c
 ...
 1050   format(/' * Error - (EQ3NR/rd3ind) The number of basis',
...
c
 ...
 1060 format(/" * Error - (EQ3NR/rd3ind) Don't recognize the",
...
c
 ...
 1164       format(a)
      ...
      enddo
      if (k .gt. 0) write (noutpt,1164) ux80(1:80)
c
      write (noutpt,2052)
 2052 format('*',78('-'),'*')
c
...
c
 ...
 1210   format(/' * Error - (EQ3NR/rd3ind) Was expecting to find the',
...
c
 ...
 1220     format(/' * Warning - (EQ3NR/rd3ind) Could not interpret the',
...
c
 ...
 1230   format(/' * Error - (EQ3NR/rd3ind) Was expecting to find an',
     $  /7x,'option check box "[ ]" in the line beginning with',
...
c
 ...
 1240   format(/' * Error - (EQ3NR/rd3ind) The qgexsh flag line',
...
c
 ...
 1250     format(/" * Error - (EQ3NR/rd3ind) Don't recognize the",
...
c
        ...
        if (qgexbs .and. .not.qgexbf) then
          write (nttyo,1260)
          write (noutpt,1260)
 1260     format(/' * Note - (EQ3NR/rd3ind) The advisory on the',
...
c
        ...
        if (qgexbs .and. qgexbf) then
          write (nttyo,1270)
          write (noutpt,1270)
 1270     format(/' * Note - (EQ3NR/rd3ind) The advisory on the',
...
c
 ...
 1620       format(/' * Error - (EQ3NR/rd3ind) Have exceeded the',
...
c
 ...
 1070     format(/' * Error - (EQ3NR/rd3ind) Read the following line',
...
c
 ...
 1710           format(/' * Error - (EQ3NR/rd3ind) Have exceeded the',
...
c
     ...
     $            ugexp(ne)(1:j2),n
 1820             format(/' * Error - (EQ3NR/rd3ind) Have exceeded the',
...
c
      write (noutpt,1682)
 1682 format('* Valid units strings (uxkgex(i,j,n)/uhfgex(i,j,n)/',
 ...
 1684       format(a)
      ...
      enddo
      if (k .gt. 0) write (noutpt,1684) ux80(1:80)
c
      write (noutpt,2052)
c
  575 continue
...
c
 ...
 1930       format(/' * Error - (EQ3NR/rd3ind) Have exceeded the',
     $      ' maximum number of ',i3,/7x,'generic ion exchange phases',
...
c
 ...
 1932     format(/' * Error - (EQ3NR/rd3ind) Data are present on the',
...
c
 ...
 2000           format(/' * Error - (EQ3NR/rd3ind) Have exceeded the',
     $          ' maximum number of ',i3,/7x,'exchange sites on a',
     $          ' generic ion exchange phase while reading',/7x,'the',
...
c
 ...
 2010       format(/' * Error - (EQ3NR/rd3ind) Was expecting to find',
...
c
                if (iei .gt. ietmax) then
                  write (noutpt,2040) ietmax,ugexji(jei,nei),
     $            ugexpi(nei),iei
                  write (nttyo,2040) ietmax,ugexji(jei,nei),
     $            ugexpi(nei),iei
 2040             format(/' * Error - (EQ3NR/rd3ind) Have exceeded the',
...
c
                ...
                j5 = ilnobl(ugexpi(nei))
                if (ustr24(1:j2) .ne. uheadx(1:j3)) then
                  write (noutpt,2014) uheadx(1:j3),ustr24(1:j2),
     $            ugexmo(ne)(1:j4),ugexpi(nei)(1:j5)
                  write (nttyo,2014) uheadx(1:j3),ustr24(1:j2),
     $            ugexmo(ne)(1:j4),ugexpi(nei)(1:j5)
 2014             format(/' * Warning - (EQ3NR/rd3ind) Was expecting',
...
c
                ...
                write (noutpt,1360) ustr(1:j2),ugexji(jei,nei)(1:j3),
     $          ugexpi(nei)(1:j4)
                write (nttyo,1360) ustr(1:j2),ugexji(jei,nei)(1:j3),
     $          ugexpi(nei)(1:j4)
 1360           format(/' * Error - (EQ3NR/rd3ind) Have unrecognized',
...
c
 ...
 1430       format(/' * Error - (EQ3NR/rd3ind) Have exceeded the',
...
c
 ...
 1460           format(/' * Error - (EQ3NR/rd3ind) Have exceeded the',
...
c
 ...
 1470         format(/' * Error - (EQ3NR/rd3ind) Have unrecognized',
     $        ' input on the line',/7x,'beginning with "',a,'".',
...
c
 ...
 1500     format(/' * Error - (EQ3NR/rd3ind) Have too many nxmod',
...
c
 ...
 1510   format(/" * Error - (EQ3NR/rd3ind) Don't recognize the",
...
c
 ...
 3094       format(a)
      ...
      enddo
      if (k .gt. 0) write (noutpt,3094) ux80(1:80)
c
      write (noutpt,2052)
c
c* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
c
 ...
 1600     format(/' * Error - (EQ3NR/rd3ind) The iopt option switch',
...
c
 ...
 1610     format(/' * Error - (EQ3NR/rd3ind) The iopt option switch',
     $    ' title line',/7x,'"',a,'"',/7x,'read from the',
...
c
 ...
 1612     format(/' * Error - (EQ3NR/rd3ind) The iopt option switch',
     $    ' title string',/7x,'"',a,'"',
...
c
 ...
 1630       format(/' * Error - (EQ3NR/rd3ind) Have too many option',
...
c
 ...
 1640       format(/' * Error - (EQ3NR/rd3ind) The following iopt',
...
c
 ...
 1650     format(/' * Error - (EQ3NR/rd3ind) The iopt option switch',
     $    /7x,'choice line',/7x,'"',a,'"',
...
c
 ...
 1660       format(/' * Error - (EQ3NR/rd3ind) The iopt option switch',
     $      ' choice line',/7x,'"',a,'"',
     $      /7x," read from the input file doesn't contain the",
     $      ' matching defined string',/7x,'"',a,'".',
...
c
     ...
     $        uopttx(n)(1:j4)
 1670         format(/" * Error - (EQ3NR/rd3ind) Don't recognize the",
...
c
 ...
 1680     format(/' * Warning - (EQ3NR/rd3ind) No option choice was',
...
c
 ...
 1694     format(/' * Warning - (EQ3NR/rd3ind) More than one option',
...
c
 ...
 1700     format(/' * Error - (EQ3NR/rd3ind) The iopg option switch',
     $    ' title line',/7x,'"',a,'"',/7x,'read from the',
     $    " input file isn't in the required format.")
          go to 990
        endif
...
c
 ...
 1712     format(/' * Error - (EQ3NR/rd3ind) The iopg option switch',
     $    ' title line',/7x,'"',a,'"',/7x,'read from the',
     $    ' input file references an option switch index',
     $    /7x,'of ',i3,', which is out of range.')
          go to 990
...
c
 ...
 1720     format(/' * Error - (EQ3NR/rd3ind) The iopg option switch',
     $    ' title string',/7x,'"',a,'"',
     $    /7x,"read from the input file doesn't contain the",
     $    ' matching defined string',/7x,'"',a,'".')
          go to 990
...
c
 ...
 1730       format(/' * Error - (EQ3NR/rd3ind) Have too many option',
...
c
 ...
 1740       format(/' * Error - (EQ3NR/rd3ind) The following iopg',
     $      /7x,'option switch choice line read from the input file',
     $      /7x,"isn't in the required format:",/7x,'"',a,'"')
            go to 990
          endif
...
c
 ...
 1750     format(/' * Error - (EQ3NR/rd3ind) The iopg option switch',
     $    /7x,'choice line',/7x,'"',a,'"',
     $    /7x,'read from the input file references an out-of-range',
     $    ' option',/7x,'choice index.')
          go to 990
...
c
 ...
 1760       format(/' * Error - (EQ3NR/rd3ind) The iopg option switch',
     $      ' choice line',/7x,'"',a,'"',
     $      /7x," read from the input file doesn't contain the",
     $      ' matching defined string',/7x,'"',a,'".',
     $      /7x,'This line belongs to the option switch whose title',
...
c
     ...
     $        uopgtx(n)(1:j4)
 1770         format(/" * Error - (EQ3NR/rd3ind) Don't recognize the",
...
c
 ...
 1780     format(/' * Warning - (EQ3NR/rd3ind) No option choice was',
...
c
 ...
 1794     format(/' * Warning - (EQ3NR/rd3ind) More than one option',
...
c
 ...
 1800     format(/' * Error - (EQ3NR/rd3ind) The iopr option switch',
     $    ' title line',/7x,'"',a,'"',/7x,'read from the',
     $    " input file isn't in the required format.")
          go to 990
        endif
...
c
 ...
 1810     format(/' * Error - (EQ3NR/rd3ind) The iopr option switch',
     $    ' title line',/7x,'"',a,'"',/7x,'read from the',
     $    ' input file references an option switch index',
     $    /7x,'of ',i3,', which is out of range.')
          go to 990
...
c
 ...
 1812     format(/' * Error - (EQ3NR/rd3ind) The iopr option switch',
     $    ' title string',/7x,'"',a,'"',
     $    /7x,"read from the input file doesn't contain the",
     $    ' matching defined string',/7x,'"',a,'".')
          go to 990
...
c
 ...
 1830       format(/' * Error - (EQ3NR/rd3ind) Have too many option',
...
c
 ...
 1840       format(/' * Error - (EQ3NR/rd3ind) The following iopr',
     $      /7x,'option switch choice line read from the input file',
     $      /7x,"isn't in the required format:",/7x,'"',a,'"')
            go to 990
          endif
...
c
 ...
 1850     format(/' * Error - (EQ3NR/rd3ind) The iopr option switch',
     $    /7x,'choice line',/7x,'"',a,'"',
     $    /7x,'read from the input file references an out-of-range',
     $    ' option',/7x,'choice index.')
          go to 990
...
c
 ...
 1860       format(/' * Error - (EQ3NR/rd3ind) The iopr option switch',
     $      ' choice line',/7x,'"',a,'"',
     $      /7x," read from the input file doesn't contain the",
     $      ' matching defined string',/7x,'"',a,'".',
     $      /7x,'This line belongs to the option switch whose title',
...
c
     ...
     $        uoprtx(n)(1:j4)
 1870         format(/" * Error - (EQ3NR/rd3ind) Don't recognize the",
...
c
 ...
 1880     format(/' * Warning - (EQ3NR/rd3ind) No option choice was',
...
c
 ...
 1894     format(/' * Warning - (EQ3NR/rd3ind) More than one option',
...
c
 ...
 1900     format(/' * Error - (EQ3NR/rd3ind) The iodb option switch',
     $    ' title line',/7x,'"',a,'"',/7x,'read from the',
     $    " input file isn't in the required format.")
          go to 990
        endif
...
c
 ...
 1910     format(/' * Error - (EQ3NR/rd3ind) The iodb option switch',
     $    ' title line',/7x,'"',a,'"',/7x,'read from the',
     $    ' input file references an option switch index',
     $    /7x,'of ',i3,', which is out of range.')
          go to 990
...
c
 ...
 1920     format(/' * Error - (EQ3NR/rd3ind) The iodb option switch',
     $    ' title string',/7x,'"',a,'"',
     $    /7x,"read from the input file doesn't contain the",
     $    ' matching defined string',/7x,'"',a,'".')
          go to 990
...
c
 ...
 1922       format(/' * Error - (EQ3NR/rd3ind) Have too many option',
...
c
 ...
 1940       format(/' * Error - (EQ3NR/rd3ind) The following iodb',
     $      /7x,'option switch choice line read from the input file',
     $      /7x,"isn't in the required format:",/7x,'"',a,'"')
            go to 990
          endif
...
c
 ...
 1950     format(/' * Error - (EQ3NR/rd3ind) The iodb option switch',
     $    /7x,'choice line',/7x,'"',a,'"',
     $    /7x,'read from the input file references an out-of-range',
     $    ' option',/7x,'choice index.')
          go to 990
...
c
 ...
 1960       format(/' * Error - (EQ3NR/rd3ind) The iodb option switch',
     $      ' choice line',/7x,'"',a,'"',
     $      /7x," read from the input file doesn't contain the",
     $      ' matching defined string',/7x,'"',a,'".',
     $      /7x,'This line belongs to the option switch whose title',
...
c
     ...
     $        uodbtx(n)(1:j4)
 1970         format(/" * Error - (EQ3NR/rd3ind) Don't recognize the",
...
c
 ...
 1980     format(/' * Warning - (EQ3NR/rd3ind) No option choice was',
...
c
 ...
 1994     format(/' * Warning - (EQ3NR/rd3ind) More than one option',
