subroutine tpraac(amuaac, amua2c, apsi, iaactr, icapr, jpfcmx, naactr, natmax, na2ctr, ncapr, ncvaac, nerr, noutpt, npx3mx, npx3t, nttyo, nwarn, pcvaac, qpdaac, qpdca, uaqsp, utripl, zaqsp)
