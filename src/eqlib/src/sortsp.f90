subroutine sortsp(iern1, iern2, istack, jcsort, jern1, jgext, jsitex, jetmax, jjsort, jssort, jstack, losp, lsort, ncmpr, nern1, nern2, netmax, noutpt, nphasx, npt, nptmax, nst, nstmax, nttyo)
