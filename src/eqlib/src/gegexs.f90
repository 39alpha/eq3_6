subroutine gegexs(cegexs, cgexj, egexjc, egexjf, egexs, iern1, iern2, ietmax, jern1, jetmax, jgext, moph, mosp, mrgexs, netmax, ngexsa, ngext, nptmax, nstmax, zchar, zgexj)
