      subroutine ckphpr(delxi,dlxmin,dph0,dxh0pr,dxh1pr,dxval0,
     $ eps100,iodb,nodbmx,nord,noutpt,nrd1mx,nttyo,ph0,ph1,
     $ ph0prn,ph1prn,prcinf,qdump,tolxsu,xi0,xi1,xval0)
c
c     This subroutine checks to see that the next pH-based print
c     point is not exceeded. Because the pH might be decreasing or
c     increasing, two potential target points (ph0prn and ph1prn)
c     must be addressed.
c
...
c
      real*8 delxi,dlxmin,dxh0pr,dxh1pr,eps100,prcinf,ph0,ph0prn,ph1,
     $ ph1prn,tolxsu,xi0,xi1,xval0,xtargv
c
c-----------------------------------------------------------------------
c
...
c* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
c
c     The first search target is the currently defined pH-based print
...
c* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
c
c     The second search target is the currently defined pH-based print
