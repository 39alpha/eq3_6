      subroutine rd3d8(cgexj,cgexpi,covali,ehi,egexsi,fo2lgi,iebal3,
...
c
 ...
 3000   format(/' * Error - (XCON3/rd3d8) The dimensioning parameter',
...
c
 ...
 3010   format(/' * Error - (XCON3/rd3d8) The dimensioning parameter',
...
c
 ...
 3020   format(/' * Error - (XCON3/rd3d8) The dimensioning parameter',
...
c
 ...
 3030   format(/' * Error - (XCON3/rd3d8) The dimensioning parameter',
...
c
 ...
 1010   format(/' * Error - (XCON3/rd3d8) The first line of a "D"',
...
c
 ...
 1015     format(/' * Error - (XCON3/rd3d8) Have too many lines in',
...
c
 ...
 1020   format(/' * Error - (XCON3/rd3d8) Was expecting to find a',
 ...
 1022   format(/' * Error - (XCON3/rd3d8) Was expecting to find an',
...
c
      if (icount .eq. 0) then
        write (nttyo,1024)
 1024   format(/' * Note - (XCON3/rd3d8) No option was selected for',
     ...
     $  ' accord with the',/7x,'data file reference pressure curve.')
      ...
      elseif (icount .gt. 1) then
        write (nttyo,1026)
 1026   format(/' * Warning - (XCON3/rd3d8) Multiple options were',
...
c
      if (icount .eq. 0) then
        write (nttyo,1034)
 1034   format(/' * Note - (XCON3/rd3d8) No option was selected',
 ...
 1036   format(/' * Warning - (XCON3/rd3d8) Multiple options were',
...
c
      if (icount .eq. 0) then
        write (nttyo,1044)
 1044   format(/' * Note - (XCON3/rd3d8) No electrical balancing',
     $  ' option was',/7x,'selected. No balancing will be done.')
        iebal3 = 0
        uebal = 'None'
      elseif (icount .gt. 1) then
        write (nttyo,1046)
 1046   format(/' * Warning - (XCON3/rd3d8) Multiple electrical',
...
c
 ...
 1047   format(/' * Note - (XCON3/rd3d8) No default redox constraint',
     $  ' option was',/7x,'selected. A default condition of log fO2= ',
     $  g12.5,' (log bars) will be used.')
        irdxc3 = 0
      elseif (icount .gt. 1) then
        write (nttyo,1048)
 1048   format(/' * Warning - (XCON3/rd3d8) Multiple default redox',
...
c
 ...
 1030   format(/' * Warning - (XCON3/rd3d8) Found ',i2,' fields',
...
c
 ...
 1050   format(/' * Error - (XCON3/rd3d8) The number of basis',
...
c
 ...
 1060 format(/" * Error - (XCON3/rd3d8) Don't recognize the",
...
c
 ...
 1210   format(/' * Error - (XCON3/rd3d8) Was expecting to find the',
...
c
 ...
 1220     format(/' * Warning - (XCON3/rd3d8) Could not interpret the',
...
c
 ...
 1230   format(/' * Error - (XCON3/rd3d8) Was expecting to find an',
     $  /7x,'option check box "[ ]" in the line beginning with',
...
c
 ...
 1240   format(/' * Error - (XCON3/rd3d8) The qgexsh flag line',
...
c
 ...
 1250     format(/" * Error - (XCON3/rd3d8) Don't recognize the",
...
c
        ...
        if (qgexbs .and. .not.qgexbf) then
          write (nttyo,1260)
 1260     format(/' * Note - (XCON3/rd3d8) The advisory on the',
...
c
        ...
        if (qgexbs .and. qgexbf) then
          write (nttyo,1270)
 1270     format(/' * Note - (XCON3/rd3d8) The advisory on the',
...
c
 ...
 1620       format(/' * Error - (XCON3/rd3d8) Have exceeded the',
...
c
 ...
 1070     format(/' * Error - (XCON3/rd3d8) Read the following line',
...
c
 ...
 1710           format(/' * Error - (XCON3/rd3d8) Have exceeded the',
...
c
     ...
     $            ugexp(ne)(1:j2),n
 1820             format(/' * Error - (XCON3/rd3d8) Have exceeded the',
...
c
 ...
 1930       format(/' * Error - (XCON3/rd3d8) Have exceeded the',
     $      ' maximum number of ',i3,/7x,'generic ion exchange phases',
...
c
 ...
 1932     format(/' * Error - (XCON3/rd3d8) Data are present on the',
...
c
 ...
 2000           format(/' * Error - (XCON3/rd3d8) Have exceeded the',
     $          ' maximum number of ',i3,/7x,'exchange sites on a',
     $          ' generic ion exchange phase while reading',/7x,'the',
...
c
 ...
 2010       format(/' * Error - (XCON3/rd3d8) Was expecting to find',
...
c
     ...
     $            ugexpi(nei),iei
 2040             format(/' * Error - (XCON3/rd3d8) Have exceeded the',
...
c
 ...
 2014             format(/' * Warning - (XCON3/rd3d8) Was expecting',
...
c
     ...
     $          ugexpi(nei)(1:j4)
 1360           format(/' * Error - (XCON3/rd3d8) Have unrecognized',
...
c
 ...
 1430       format(/' * Error - (XCON3/rd3d8) Have exceeded the',
...
c
 ...
 1460           format(/' * Error - (XCON3/rd3d8) Have exceeded the',
...
c
 ...
 1470         format(/' * Error - (XCON3/rd3d8) Have unrecognized',
     $        ' input on the line',/7x,'beginning with "',a,'".',
...
c
 ...
 1500     format(/' * Error - (XCON3/rd3d8) Have too many nxmod',
...
c
 ...
 1510   format(/" * Error - (XCON3/rd3d8) Don't recognize the",
...
c
 ...
 1600     format(/' * Error - (XCON3/rd3d8) The iopt option switch',
...
c
 ...
 1610     format(/' * Error - (XCON3/rd3d8) The iopt option switch',
     $    ' title line',/7x,'"',a,'"',/7x,'read from the',
...
c
 ...
 1612     format(/' * Error - (XCON3/rd3d8) The iopt option switch',
     $    ' title string',/7x,'"',a,'"',
...
c
 ...
 1630       format(/' * Error - (XCON3/rd3d8) Have too many option',
...
c
 ...
 1640       format(/' * Error - (XCON3/rd3d8) The following iopt',
...
c
 ...
 1650     format(/' * Error - (XCON3/rd3d8) The iopt option switch',
     $    /7x,'choice line',/7x,'"',a,'"',
...
c
 ...
 1660       format(/' * Error - (XCON3/rd3d8) The iopt option switch',
     $      ' choice line',/7x,'"',a,'"',
     $      /7x," read from the input file doesn't contain the",
     $      ' matching defined string',/7x,'"',a,'".',
...
c
     ...
     $        uopttx(n)(1:j4)
 1670         format(/" * Error - (XCON3/rd3d8) Don't recognize the",
...
c
 ...
 1680     format(/' * Warning - (XCON3/rd3d8) No option choice was',
...
c
 ...
 1694     format(/' * Warning - (XCON3/rd3d8) More than one option',
...
c
 ...
 1700     format(/' * Error - (XCON3/rd3d8) The iopg option switch',
     $    ' title line',/7x,'"',a,'"',/7x,'read from the',
     $    " input file isn't in the required format.")
          go to 990
        endif
...
c
 ...
 1712     format(/' * Error - (XCON3/rd3d8) The iopg option switch',
     $    ' title line',/7x,'"',a,'"',/7x,'read from the',
     $    ' input file references an option switch index',
     $    /7x,'of ',i3,', which is out of range.')
          go to 990
...
c
 ...
 1720     format(/' * Error - (XCON3/rd3d8) The iopg option switch',
     $    ' title string',/7x,'"',a,'"',
     $    /7x,"read from the input file doesn't contain the",
     $    ' matching defined string',/7x,'"',a,'".')
          go to 990
...
c
 ...
 1730       format(/' * Error - (XCON3/rd3d8) Have too many option',
...
c
 ...
 1740       format(/' * Error - (XCON3/rd3d8) The following iopg',
     $      /7x,'option switch choice line read from the input file',
     $      /7x,"isn't in the required format:",/7x,'"',a,'"')
            go to 990
          endif
...
c
 ...
 1750     format(/' * Error - (XCON3/rd3d8) The iopg option switch',
     $    /7x,'choice line',/7x,'"',a,'"',
     $    /7x,'read from the input file references an out-of-range',
     $    ' option',/7x,'choice index.')
          go to 990
...
c
 ...
 1760       format(/' * Error - (XCON3/rd3d8) The iopg option switch',
     $      ' choice line',/7x,'"',a,'"',
     $      /7x," read from the input file doesn't contain the",
     $      ' matching defined string',/7x,'"',a,'".',
     $      /7x,'This line belongs to the option switch whose title',
...
c
     ...
     $        uopgtx(n)(1:j4)
 1770         format(/" * Error - (XCON3/rd3d8) Don't recognize the",
...
c
 ...
 1780     format(/' * Warning - (XCON3/rd3d8) No option choice was',
...
c
 ...
 1794     format(/' * Warning - (XCON3/rd3d8) More than one option',
...
c
 ...
 1800     format(/' * Error - (XCON3/rd3d8) The iopr option switch',
     $    ' title line',/7x,'"',a,'"',/7x,'read from the',
     $    " input file isn't in the required format.")
          go to 990
        endif
...
c
 ...
 1810     format(/' * Error - (XCON3/rd3d8) The iopr option switch',
     $    ' title line',/7x,'"',a,'"',/7x,'read from the',
     $    ' input file references an option switch index',
     $    /7x,'of ',i3,', which is out of range.')
          go to 990
...
c
 ...
 1812     format(/' * Error - (XCON3/rd3d8) The iopr option switch',
     $    ' title string',/7x,'"',a,'"',
     $    /7x,"read from the input file doesn't contain the",
     $    ' matching defined string',/7x,'"',a,'".')
          go to 990
...
c
 ...
 1830       format(/' * Error - (XCON3/rd3d8) Have too many option',
...
c
 ...
 1840       format(/' * Error - (XCON3/rd3d8) The following iopr',
     $      /7x,'option switch choice line read from the input file',
     $      /7x,"isn't in the required format:",/7x,'"',a,'"')
            go to 990
          endif
...
c
 ...
 1850     format(/' * Error - (XCON3/rd3d8) The iopr option switch',
     $    /7x,'choice line',/7x,'"',a,'"',
     $    /7x,'read from the input file references an out-of-range',
     $    ' option',/7x,'choice index.')
          go to 990
...
c
 ...
 1860       format(/' * Error - (XCON3/rd3d8) The iopr option switch',
     $      ' choice line',/7x,'"',a,'"',
     $      /7x," read from the input file doesn't contain the",
     $      ' matching defined string',/7x,'"',a,'".',
     $      /7x,'This line belongs to the option switch whose title',
...
c
     ...
     $        uoprtx(n)(1:j4)
 1870         format(/" * Error - (XCON3/rd3d8) Don't recognize the",
...
c
 ...
 1880     format(/' * Warning - (XCON3/rd3d8) No option choice was',
...
c
 ...
 1894     format(/' * Warning - (XCON3/rd3d8) More than one option',
...
c
 ...
 1900     format(/' * Error - (XCON3/rd3d8) The iodb option switch',
     $    ' title line',/7x,'"',a,'"',/7x,'read from the',
     $    " input file isn't in the required format.")
          go to 990
        endif
...
c
 ...
 1910     format(/' * Error - (XCON3/rd3d8) The iodb option switch',
     $    ' title line',/7x,'"',a,'"',/7x,'read from the',
     $    ' input file references an option switch index',
     $    /7x,'of ',i3,', which is out of range.')
          go to 990
...
c
 ...
 1920     format(/' * Error - (XCON3/rd3d8) The iodb option switch',
     $    ' title string',/7x,'"',a,'"',
     $    /7x,"read from the input file doesn't contain the",
     $    ' matching defined string',/7x,'"',a,'".')
          go to 990
...
c
 ...
 1922       format(/' * Error - (XCON3/rd3d8) Have too many option',
...
c
 ...
 1940       format(/' * Error - (XCON3/rd3d8) The following iodb',
     $      /7x,'option switch choice line read from the input file',
     $      /7x,"isn't in the required format:",/7x,'"',a,'"')
            go to 990
          endif
...
c
 ...
 1950     format(/' * Error - (XCON3/rd3d8) The iodb option switch',
     $    /7x,'choice line',/7x,'"',a,'"',
     $    /7x,'read from the input file references an out-of-range',
     $    ' option',/7x,'choice index.')
          go to 990
...
c
 ...
 1960       format(/' * Error - (XCON3/rd3d8) The iodb option switch',
     $      ' choice line',/7x,'"',a,'"',
     $      /7x," read from the input file doesn't contain the",
     $      ' matching defined string',/7x,'"',a,'".',
     $      /7x,'This line belongs to the option switch whose title',
...
c
     ...
     $        uodbtx(n)(1:j4)
 1970         format(/" * Error - (XCON3/rd3d8) Don't recognize the",
...
c
 ...
 1980     format(/' * Warning - (XCON3/rd3d8) No option choice was',
...
c
 ...
 1994     format(/' * Warning - (XCON3/rd3d8) More than one option',
