...
1030 format(/' * Error - (XCON3/rd3w7) Have too many lines in the',/7x,'secondary title. The code is only dimensioned for ',i4,/7x,'lines. Reduce the size of the title or increase the',/7x,'dimensioning parameter ntitpa.')
...
1210 format(/' * Error - (XCON3/rd3w7) Have too many nxmod',/7x,'alter/suppress options. The code is only dimensioned',/7x,'for ',i3,' such options. Reduce the number of such',' options',/7x,'or increase the dimensioning parameter',' nxmdpa.')
...
1260 format(/' * Error - (XCON3/rd3w7) Have too many basis',/7x,'species present. The code is only dimensioned',/7x,'for ',i3,' basis species. Reduce the number of such',/7x,'species or increase the dimensioning parameter nsqpar.')
...
1310 format(/' * Error - (XCON3/rd3w7) Have too many solid',/7x,'solutions present. The code is only dimensioned',/7x,'for ',i3,' solid solutions. Reduce the number of such',/7x,'phases or increase the dimensioning parameter nxtpar.')
...
1330 format(/' * Error - (XCON3/rd3w7) Solid solution',/7x,'"',a,'" has too many end-members present.',/7x,'This code is only dimensioned for ',i3,' end-members',/7x,'per solid solution. Reduce the number of end-members',/7x,'or increase the dimensioning parameter iktpar.')
