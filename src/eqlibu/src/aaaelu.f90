subroutine aaaelu(ustelu,uveelu)
    ...
    !! This library supports various EQ3/6 codes. It contains subroutines
    !! with generic utility and mathematical functions. The EQLIB libary
    !! contains subroutines that address elements of geochemical modeling
    !! calculations that are common to EQ3NR and EQ6. However, it does
    !! not contain subroutines that deal with calculations specific to
    !! activity coefficient models. The EQLIBG library contains those
    !! subroutines. The EQLIBU library contains subroutines with generic
    ...
    !! concatenated source code for EQLIBU. Concatenation is normally
    ...
    !!   None
    !! Output:
    !!   ustelu = EQLIBU stage number
    !!   uveelu = EQLIBU version number
    implicit none
