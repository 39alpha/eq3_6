...
1210 format('| phases except',t21,'|  ',a22,t46,'|  ',a23,t72,'|n')
...
1290 format('| REACTANT',t20,'|  ',a22,t45,'|status',t55,'|',i2,t72,'|')

                        write (newin,1300) morr(nrc),modr(nrc)
1300 format('| moles remaining',t20,'|',1pg12.5,t45,'|destroyed',t55,'|',1pg12.5,t72,'|')

                        write (newin,1310) umint(jcode(nrc)),sk(nrc)
1310 format('| reactant type',t20,'|',2x,a14,t45,'|sk',t55,'|',1pg12.5,t72,'|')

                        write (newin,1320) nsk(nrc),fk(nrc)
1320 format('| surface type',t20,'|',2x,i2,t45,'|fk',t55,'|',1pg12.5,t72,'|')
...
1330 format('| end-member',t20,'|',a24,t45,'|mole fr',t55,'| ',1pg14.6,t72,'|ss,n')
...
170 continue
                                ...
                                write (newin,1340)
1340 format('| end-member',t20,'|',t45,'|mole fr',t55,'|',t72,'|ss,n')
                            end if
...
1360 format('| element',t20,'|  ',a8,t35,'|moles',t45,'|',1x,1pe25.15,t72,'|sp,n')
...
190 continue
                                    ...
                                    write (newin,1370)
1370 format('| volume',t20,'|',t45,'|',t55,'|',t72,'|sp',/'| element',t20,'|',t45,'|moles',t55,'|',t72,'|sp,n')
                                end if
...
1390 format('| rate constant rk',i1,t20,'|',1pg12.5,t45,'|csigma',i1,t55,'|',t72,'|')

210 continue
                                    else if (nrk(1,nrc) .eq. 2) then
                                        do 230 i = 1,imech(1,nrc)
                                            write (newin,1395) i,rk0(i,1,nrc),i,csigma(i,1,nrc)
1395 format('| rate constant rk',i1,t20,'|',1pg12.5,t45,'|csigma',i1,t55,'| ',1pg14.6,t72,'|')

                                            do 220 n = 1,ndact(i,1,nrc)
                                                write (newin,1400) udac(n,i,1,nrc),cdac(n,i,1,nrc)
1400 format('| aqueous species  | ',a23,t45,'|cdac',t55,'| ',1pg14.5,t72,'|n')

220 continue

                                                write (newin,1410) trk0(i,1,nrc)
1410 format('| temperature (c)  | ',1pg12.5,t45,'|',t55,'|',t72,'|234')

                                                if (iact(i,1,nrc) .eq. 1) then
                                                    write (newin,1420) eact(i,1,nrc)
1420 format('| act. energy-kcal | ',1pg12.5,t45,'|enthalpy',t55,'|',t72,'|234')
                                                else if (iact(i,1,nrc) .eq. 2) then
                                                    write (newin,1430) hact(i,1,nrc)
1430 format('| act. energy-kcal | ',t45,'|enthalpy',t55,'| ',1pg12.5,t72,'|234')
                                                end if
...
2180 format('c pickup file written by eq6.',a4,a6,t72,'|',/'c  supported by eqlib.',a4,a6,t72,'|')
                                                                                                end if

                                                                                                if (ucode(1:5).eq.'EQ3NR' .or. ucode(1:5).eq.'eq3nr') then
                                                                                                    write (newin,2190) urelno,ustage,ueqlrn,ueqlst
2190 format('c pickup file written by eq3nr.',a4,a6,t72,'|',/'c  supported by eqlib.',a4,a6,t72,'|')
                                                                                                end if
