...
1015 format(/' * Error - (XCON6/rd6w6) Have too many lines in the',/7x,'main title. The code is only dimensioned for ',i4,/7x,'lines. Reduce the size of the title or increase the',/7x,'dimensioning parameter ntitpa.')
...
1315 format(/' * Error - (XCON6/rd6w6) Have too many mineral',/7x,'subset-selection suppression options. The code is',/7x,'only dimensioned for ',i3,' such options. Reduce the',/7x,'number of options or increase the dimensioning',/7x,'parameter nxoppa.')
...
1345 format(/' * Error - (XCON6/rd6w6) Have too many',/7x,'exceptions specified to the mineral subset-selection',/7x,'suppression options. The code is only dimensioned',/7x,'for ',i3,'exceptions. Reduce the number of exceptions',/7x,'or increase the dimensioning parameter nxoppa.')
...
1385 format(/' * Error - (XCON6/rd6w6) Have too many gases whose',/7x,'fugacities are to be fixed. The code is only dimensioned',/7x,'for ',i4,' such gases. Reduce the number of gases or',/7x,'increase the dimensioning parameter nffgpa.')
...
1425 format(/' * Error - (XCON6/rd6w6) Have too many reactants',/7x,'The code is only dimensioned for ',i4,' reactants.',/7x,'Reduce the number of reactants or increase the',/7x,'dimensioning parameter nrctpa.')
...
1445 format(/' * Error - (XCON6/rd6w6) Have too many solid',/7x,'solution reactants. The code is only dimensioned',/7x,'for ',i4,' such reactants. Reduce the number of',/7x,'such reactants or increase the dimensioning',' parameter nxrtpa.')
...
1446 format(/' * Error - (XCON6/rd6w6) Have too many',' end-members',/7x,'in the solid solution reactant',' "',a24,'".',/7x,'The code is only dimensioned for ',i4,' end-members per',/7x,'solid solution. Reduce',' the number of end-members or',/7x,'increase the dimensioning parameter iktpar.')
...
1447 format(/' * Error - (XCON6/rd6w6) Have too many special',/7x,'reactants. The code is only dimensioned for ',i4,/7x,'such reactants. Reduce the number of such reactants',/7x,'or increase the dimensioning parameter nsrtpa.')
...
1510 format(/' * Error - (XCON6/rd6w6) Have too many','  chemical',/7x,'elements in the special  reactant "',a24,'".',/7x,'The code is only dimensioned for ',i4,' elements.',/7x,'Reduce the number of elements or increase the',/7x,'dimensioning parameter nctpar.')
...
1550 format(/' * Error - (XCON6/rd6w6) Have too many rate',/7x,'constants in the forward direction rate law for',/7x,'reactant "',a24,'". The code is only',/7x,'dimensioned for ',i2,' rate constants per rate law.',/7x,'Reduce the number of rate constants or increase the',/7x,'dimensioning parameter imchpa.')
...
1580 format(12x,i2)
                                        ...
                                        do 220 i = 1,imech(1,nrc)
                                            read (ninpts,1600,err=990) rk0(i,1,nrc),ndact(i,1,nrc),csigma(i,1,nrc)
1600 format(12x,e12.5,12x,i2,22x,e12.5)

                                            if (ndact(i,1,nrc) .gt. ndctmx) then
                                                write (nttyo,1655) ureac(nrc),i,ndctmx
1655 format(/' * Error - (XCON6/rd6w6) Have too many',/7x,'species in the activity product in term ',i2,/7x,'of the forward direction rate law for reactant',/7x,'"',a24,'". The code is only dimensioned for ',i3,/7x,'such species. Reduce the number of such species',/7x,'or increase the dimensioning parameter ndctpa.')
...
220 continue
                                                ...
                                                read (ninpts,1560,err=990) (rk0(i,1,nrc), j = 1,3)
                                                ...
                                                do 240 i = 1,imech(1,nrc)
                                                    read (ninpts,1600,err=990) rk0(i,1,nrc),ndact(i,1,nrc)
...
240 continue
                                                        ...
                                                        read (ninpts,1560,err=990) (rk0(i,1,nrc), j = 1,2)
                                                    end if
...
1673 format(/' * Error - (XCON6/rd6w6) Have too many rate',/7x,'constants in the backward direction rate law for',/7x,'reactant "',a24,'". The code is only',/7x,'dimensioned for ',i2,' rate constants per rate law.',/7x,'Reduce the number of rate constants or increase the',/7x,'dimensioning parameter imchpa.')
                                                        ...
                                                        do 260 i = 1,imech(2,nrc)
                                                            read (ninpts,1600,err=990) rk0(i,2,nrc),ndact(i,2,nrc),csigma(i,2,nrc)

                                                            if (ndact(i,2,nrc) .gt. ndctmx) then
                                                                write (nttyo,1675) ureac(nrc),i,ndctmx
1675 format(/' * Error - (XCON6/rd6w6) Have too many',/7x,'species in the activity product in term ',i2,/7x,'of the backward direction rate law for reactant',/7x,'"',a24,'". The code is only dimensioned for ',i3,/7x,'such species. Reduce the number of such species',/7x,'or increase the dimensioning parameter ndctpa.')
...
260 continue
                                                                ...
                                                                i = 1
                                                                read (ninpts,1560,err=990) rk0(i,2,nrc)
                                                                ...
                                                                do 280 i = 1,imech(2,nrc)
                                                                    read (ninpts,1600,err=990) rk0(i,2,nrc),ndact(i,2,nrc)
...
280 continue
                                                                        ...
                                                                        read (ninpts,1560,err=990) (rk0(i,2,nrc), j = 1,2)
                                                                    end if
...
3002 format(/' * Error - (XCON6/rd6w6) Have too many lines in the',/7x,'secondary title. The code is only dimensioned for ',i4,/7x,'lines. Reduce the size of the title or increase the',/7x,'dimensioning parameter ntitpa.')
...
410 continue
                                                                    ...
                                                                    ! Ion to define equivalent stoichiometric ionic strength.
                                                                    read (ninpts,3005,err=990) uacion
3005 format(12x,a24)
...
3035 format(/' * Error - (XCON6/rd6w6) Have too many nxmod',/7x,'alter/suppress options. The code is only dimensioned',/7x,'for ',i3,' such options. Reduce the number of such',' options',/7x,'or increase the dimensioning parameter',' nxmdpa.')
...
3095 format(/' * Error - (XCON6/rd6w6) Have too many chemical',/7x,'elements present. The code is only dimensioned',/7x,'for ',i3,' elements. Reduce the number of elements',/7x,'or increase the dimensioning parameter nctpar.')
...
3100 format(/' * Error - (XCON6/rd6w6) Have too many master',/7x,'variables. The code is only dimensioned for ',i3,/7x,'master variables. Reduce the number of such variables',/7x,'or increase the dimensioning parameter kpar.')
...
3190 format(/' * Error - (XCON6/rd6w6) Have too many mineral',/7x,'species in the physically removed system. The code is',/7x,'only dimensioned for ',i3,' such species. Reduce the',/7x,'number of such species or increase the dimensioning',/7x,'parameter nprspa.')
