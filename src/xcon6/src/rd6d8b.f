      subroutine rd6d8b(cbsri,cdac,cesri,cgexj,csigma,dlxdmp,dlxmx0,
...
c     format for version 8.0 beta 1.
c
c     This subroutine is a near-clone of EQ6/rd6d8.f. The key
c     differences are that the beta does not provide for the
c     following:
c
c       1. The use of generic ion exchanger phases as reactants
c       2. The nsk = 2 surface area option (n**2/3 growth law)
c       3. The iopt(14) option for choosing ODE corrector mode
c       4. The iodb(7) debugging print option to print general
c          search information
c       5. The iodb(8) debugging print option to print ODE corrector
c          iteration information
c       6. The specification of the nordmx maximum order parameter
c
...
c
     ...
     $ ndctmx,nertmx,netmax,nffgmx,nodbmx,nopgmx,noprmx,noptmx,nprpmx,
     $ nprsmx,nptkmx,nrctmx,nsrtmx,ntitmx,nttkmx,nxmdmx,nxopmx,nxpemx,
     $ nxrtmx
c
...
c
      real*8 dlxdmp,dlxmx0,dlxpll,dlxplo,dlxprl,dlxprn,electr,pressb,
     $ pressi,tempcb,tempci,timmxi,tistti,tolbt,toldl,tolsat,tolxsf,
     $ ximaxi,xistti
c
c-----------------------------------------------------------------------
c
...
c
      integer ilnobl
c
      logical qmark,qnone,qnonep,qnones,qnoner,qokay,qstop
c
...
c
 ...
 3000   format(/' * Error - (XCON6/rd6d8b) The dimensioning parameter',
...
c
 ...
 3010   format(/' * Error - (XCON6/rd6d8b) The dimensioning parameter',
...
c
 ...
 3020   format(/' * Error - (XCON6/rd6d8b) The dimensioning parameter',
...
c
 ...
 3030   format(/' * Error - (XCON6/rd6d8b) The dimensioning parameter',
...
c
 ...
 1010   format(/' * Error - (XCON6/rd6d8b) The first line of a "D"',
...
c
 ...
 1015     format(/' * Error - (XCON6/rd6d8b) Have too many lines in',
...
c
 ...
 1020   format(/' * Error - (XCON6/rd6d8b) Was expecting to find a',
 ...
 1022   format(/' * Error - (XCON6/rd6d8b) Was expecting to find an',
...
c
 ...
 1023   format(/' * Warning - (XCON6/rd6d8b) No option was selected for',
 ...
 1024   format(/' * Warning - (XCON6/rd6d8b) Multiple options were',
...
c
 ...
 1030   format(/' * Warning - (XCON6/rd6d8b) No option was selected for',
     ...
     $  ' accord with the',/7x,'data file reference pressure curve.')
      ...
      elseif (icount .gt. 1) then
        write (nttyo,1026)
 1026   format(/' * Warning - (XCON6/rd6d8b) Multiple options were',
...
c
 ...
 1520     format(/' * Error - (XCON6/rd6d8b) Have too many reactants',
...
c
 ...
 1060   format(/" * Error - (XCON6/rd6d8b) Don't recognize the",
...
c
 ...
 1065   format(/" * Error - (XCON6/rd6d8b) Don't recognize the",
...
c
 ...
 1550       format(/' * Error - (XCON6/rd6d8b) Have too many solid',
...
c
 ...
 1590         format(/' * Error - (XCON6/rd6d8b) Have too many',
...
c
 ...
 1600       format(/' * Error - (XCON6/rd6d8b) Have too many special',
...
c
 ...
 1660         format(/' * Error - (XCON6/rd6d8b) Have too many',
...
c
 ...
 1700         format(/' * Error - (XCON6/rd6d8b) Have too many basis',
...
c
 ...
 1710       format(/' * Error - (XCON6/rd6d8b) Have too many generic',
...
c
 ...
 1716           format(/' * Error - (XCON6/rd6d8b) Have too many',
...
c
 ...
 1724           format(/' * Error - (XCON6/rd6d8b) Have too many',
...
c       (ssfcar(n), cm2/g) from a two-line header.
c
        uheadx = '->'
        nfldtx = 4
        call rdd2lh(nfldmx,nfldt,nfldtx,ninpts,nlchmx,
...
c
 ...
 1033     format(/' * Warning - (XCON6/rd6d8b) No option was selected',
 ...
 1035     format(/' * Warning - (XCON6/rd6d8b) Multiple options were',
...
c
 ...
 1075     format(/" * Error - (XCON6/rd6d8b) Don't recognize the",
...
c
 ...
 1960         format(/' * Error - (XCON6/rd6d8b) Have too many rate',
...
c
 ...
 1080           format(/" * Error - (XCON6/rd6d8b) Have an incorrect",
...
c
 ...
 1958             format(/' * Error - (XCON6/rd6d8b) Have no',
...
c
 ...
 1118             format(/' * Warning - (XCON6/rd6d8b) No option was',
 ...
 1120             format(/' * Warning - (XCON6/rd6d8b) Multiple option',
     $            's were selected for',/7x,'treating the temperature',
     $            ' dependence of the ',a,' rate constant',/7x,'for',
     $            ' term ',i2,' of the rate equation for the reactant',
     $            ' ',a,'.',/7x,'The temperature dependence will be',
     $            ' set to zero.')
...
c
     ...
     $            ndctmx
 1130             format(/' * Error - (XCON6/rd6d8b) Have too many',
...
c           Linear rate law.
c
c           Loop on mechanism. However, only one "mechanism" is
c           allowed.
c
            imh = 0
            do ii = 1,imchmx + 1
...
c
 ...
 1964           format(/' * Error - (XCON6/rd6d8b) Have more than the',
...
c
 ...
 1952       format(/' * Error - (XCON6/rd6d8b) Programming error trap:',
...
c
 ...
 1607     format(/' * Error - (XCON6/rd6d8b) The iopt option switch',
...
c
 ...
 1610     format(/' * Error - (XCON6/rd6d8b) The iopt option switch',
     $    ' title line',/7x,'"',a,'"',/7x,'read from the',
...
c
 ...
 1612     format(/' * Error - (XCON6/rd6d8b) The iopt option switch',
     $    ' title string',/7x,'"',a,'"',
...
c
 ...
 1630       format(/' * Error - (XCON6/rd6d8b) Have too many option',
...
c
 ...
 1640       format(/' * Error - (XCON6/rd6d8b) The following iopt',
...
c
 ...
 1650     format(/' * Error - (XCON6/rd6d8b) The iopt option switch',
     $    /7x,'choice line',/7x,'"',a,'"',
...
c
 ...
 1662       format(/' * Error - (XCON6/rd6d8b) The iopt option switch',
     $      ' choice line',/7x,'"',a,'"',
     $      /7x," read from the INPUT file doesn't contain the",
     $      ' matching defined string',/7x,'"',a,'".',
...
c
     ...
     $        uopttx(n)(1:j4)
 1670         format(/" * Error - (XCON6/rd6d8b) Don't recognize the",
...
c
 ...
 1680     format(/' * Warning - (XCON6/rd6d8b) No option choice was',
...
c
 ...
 1694     format(/' * Warning - (XCON6/rd6d8b) More than one option',
...
c
 ...
 1800     format(/' * Error - (XCON6/rd6d8b) The iopr option switch',
     $    ' title line',/7x,'"',a,'"',/7x,'read from the',
     $    " INPUT file isn't in the required format.")
          go to 990
        endif
...
c
 ...
 1810     format(/' * Error - (XCON6/rd6d8b) The iopr option switch',
     $    ' title line',/7x,'"',a,'"',/7x,'read from the',
     $    ' INPUT file references an option switch index',
     $    /7x,'of ',i3,', which is out of range.')
          go to 990
...
c
 ...
 1812     format(/' * Error - (XCON6/rd6d8b) The iopr option switch',
     $    ' title string',/7x,'"',a,'"',
     $    /7x,"read from the INPUT file doesn't contain the",
     $    ' matching defined string',/7x,'"',a,'".')
          go to 990
...
c
 ...
 1830       format(/' * Error - (XCON6/rd6d8b) Have too many option',
...
c
 ...
 1840       format(/' * Error - (XCON6/rd6d8b) The following iopr',
     $      /7x,'option switch choice line read from the INPUT file',
     $      /7x,"isn't in the required format:",/7x,'"',a,'"')
            go to 990
          endif
...
c
 ...
 1850     format(/' * Error - (XCON6/rd6d8b) The iopr option switch',
     $    /7x,'choice line',/7x,'"',a,'"',
     $    /7x,'read from the INPUT file references an out-of-range',
     $    ' option',/7x,'choice index.')
          go to 990
...
c
 ...
 1860       format(/' * Error - (XCON6/rd6d8b) The iopr option switch',
     $      ' choice line',/7x,'"',a,'"',
     $      /7x," read from the INPUT file doesn't contain the",
     $      ' matching defined string',/7x,'"',a,'".',
     $      /7x,'This line belongs to the option switch whose title',
...
c
     ...
     $        uoprtx(n)(1:j4)
 1870         format(/" * Error - (XCON6/rd6d8b) Don't recognize the",
...
c
 ...
 1880     format(/' * Warning - (XCON6/rd6d8b) No option choice was',
...
c
 ...
 1894     format(/' * Warning - (XCON6/rd6d8b) More than one option',
...
c
 ...
 1900     format(/' * Error - (XCON6/rd6d8b) The iodb option switch',
     $    ' title line',/7x,'"',a,'"',/7x,'read from the',
     $    " INPUT file isn't in the required format.")
          go to 990
        endif
...
c
 ...
 1910     format(/' * Error - (XCON6/rd6d8b) The iodb option switch',
     $    ' title line',/7x,'"',a,'"',/7x,'read from the',
     $    ' INPUT file references an option switch index',
     $    /7x,'of ',i3,', which is out of range.')
          go to 990
...
c
 ...
 1920     format(/' * Error - (XCON6/rd6d8b) The iodb option switch',
     $    ' title string',/7x,'"',a,'"',
     $    /7x,"read from the INPUT file doesn't contain the",
     $    ' matching defined string',/7x,'"',a,'".')
          go to 990
...
c
 ...
 1922       format(/' * Error - (XCON6/rd6d8b) Have too many option',
...
c
 ...
 1940       format(/' * Error - (XCON6/rd6d8b) The following iodb',
     $      /7x,'option switch choice line read from the INPUT file',
     $      /7x,"isn't in the required format:",/7x,'"',a,'"')
            go to 990
          endif
...
c
 ...
 1950     format(/' * Error - (XCON6/rd6d8b) The iodb option switch',
     $    /7x,'choice line',/7x,'"',a,'"',
     $    /7x,'read from the INPUT file references an out-of-range',
     $    ' option',/7x,'choice index.')
          go to 990
...
c
 ...
 1962       format(/' * Error - (XCON6/rd6d8b) The iodb option switch',
     $      ' choice line',/7x,'"',a,'"',
     $      /7x," read from the INPUT file doesn't contain the",
     $      ' matching defined string',/7x,'"',a,'".',
     $      /7x,'This line belongs to the option switch whose title',
...
c
     ...
     $        uodbtx(n)(1:j4)
 1970         format(/" * Error - (XCON6/rd6d8b) Don't recognize the",
...
c
 ...
 1980     format(/' * Warning - (XCON6/rd6d8b) No option choice was',
...
c
 ...
 1994     format(/' * Warning - (XCON6/rd6d8b) More than one option',
...
c
 ...
 1320     format(/' * Error - (XCON6/rd6d8b) Have too many mineral',
...
c
 ...
 3060   format(/" * Error - (XCON6/rd6d8b) Don't recognize the",
...
c
 ...
 1370     format(/' * Error - (XCON6/rd6d8b) Have too many',
...
c
 ...
 1420     format(/' * Error - (XCON6/rd6d8b) Have too many gases whose',
...
c
 ...
 5015     format(/' * Error - (XCON6/rd6d8b) Have too many lines in',
...
c
 ...
 1620       format(/' * Error - (XCON6/rd6d8b) Have exceeded the',
...
c
     ...
     $  nttyo,qrderr,ufield,uline1,ulscr)
        ...
        if (ustr24(1:8) .ne. uheadx(1:8)) then
          ...
          j2 = min(j2,70)
          write (nttyo,1070) uline1(1:j2)
 1070     format(/' * Error - (XCON6/rd6d8b) Read the following line',
...
c
 ...
 1220           format(/' * Error - (XCON6/rd6d8b) Have exceeded the',
...
c
     ...
     $            ugexp(ne)(1:j2),n
 1820             format(/' * Error - (XCON6/rd6d8b) Have exceeded the',
...
c
 ...
 1500     format(/' * Error - (XCON6/rd6d8b) Have too many nxmod',
...
c
 ...
 1510   format(/" * Error - (XCON6/rd6d8b) Don't recognize the",
...
c
 ...
 1705     format(/' * Error - (XCON6/rd6d8b) The iopg option switch',
     $    ' title line',/7x,'"',a,'"',/7x,'read from the',
     $    " INPUT file isn't in the required format.")
          go to 990
        endif
...
c
 ...
 1712     format(/' * Error - (XCON6/rd6d8b) The iopg option switch',
     $    ' title line',/7x,'"',a,'"',/7x,'read from the',
     $    ' INPUT file references an option switch index',
     $    /7x,'of ',i3,', which is out of range.')
          go to 990
...
c
 ...
 1720     format(/' * Error - (XCON6/rd6d8b) The iopg option switch',
     $    ' title string',/7x,'"',a,'"',
     $    /7x,"read from the INPUT file doesn't contain the",
     $    ' matching defined string',/7x,'"',a,'".')
          go to 990
...
c
 ...
 1730       format(/' * Error - (XCON6/rd6d8b) Have too many option',
...
c
 ...
 1740       format(/' * Error - (XCON6/rd6d8b) The following iopg',
     $      /7x,'option switch choice line read from the INPUT file',
     $      /7x,"isn't in the required format:",/7x,'"',a,'"')
            go to 990
          endif
...
c
 ...
 1750     format(/' * Error - (XCON6/rd6d8b) The iopg option switch',
     $    /7x,'choice line',/7x,'"',a,'"',
     $    /7x,'read from the INPUT file references an out-of-range',
     $    ' option',/7x,'choice index.')
          go to 990
...
c
 ...
 1760       format(/' * Error - (XCON6/rd6d8b) The iopg option switch',
     $      ' choice line',/7x,'"',a,'"',
     $      /7x," read from the INPUT file doesn't contain the",
     $      ' matching defined string',/7x,'"',a,'".',
     $      /7x,'This line belongs to the option switch whose title',
...
c
     ...
     $        uopgtx(n)(1:j4)
 1770         format(/" * Error - (XCON6/rd6d8b) Don't recognize the",
...
c
 ...
 1780     format(/' * Warning - (XCON6/rd6d8b) No option choice was',
...
c
 ...
 1794     format(/' * Warning - (XCON6/rd6d8b) More than one option',
...
c
 ...
 3240   format(/' * Error - (XCON6/rd6d8b) Have too many chemical',
...
c
 ...
 3250   format(/' * Error - (XCON6/rd6d8b) Have too many basis',
...
c
 ...
 3260   format(/' * Error - (XCON6/rd6d8b) Have too many matrix',
...
c
 ...
 5010   format(/' * Error - (XCON6/rd6d8b) Found ',i2,' fields',
...
c
 ...
 5020   format(/' * Error - (XCON6/rd6d8b) The number of mass balance',
...
c
 ...
 5030   format(/" * Error - (XCON6/rd6d8b) Can't identify the",
...
c
 ...
 5040     format(/' * Error - (XCON6/rd6d8b) Found that the mass',
...
c
 ...
 5050   format(/' * Error - (XCON6/rd6d8b) The number of matrix',
...
c
 ...
 3640       format(/' * Error - (XCON6/rd6d8b) Have too many phases',
...
c
 ...
 3680           format(/' * Error - (XCON6/rd6d8b) Have too many',
...
c
 ...
 2000           format(/' * Error - (XCON6/rd6d8b) Have exceeded the',
