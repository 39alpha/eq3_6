...
1410 format(3x,'species= ',a24,/5x,'moffg= ',1pe12.5,4x,'xlkffg= ',1pe12.5)
...
1590 format(5x,'imech= ',i2)
                                        ...
                                        do 220 i = 1,imech(1,nrc)
                                            write (newin,1610) rk0(i,1,nrc),trk0(i,1,nrc),iact(i,1,nrc)
1610 format(7x,'rk0= ',1pe12.5,6x,'trk0= ',1pe12.5,6x,'iact= ',i2)
...
1850 format(6x,'rpk0= ',1pe12.5,5x,'trpk0= ',1pe12.5,5x,'iactp= ',i2)
...
2180 format('* pickup file written by EQ6, version ',a4,' (',a8,')',/'*  supported by EQLIB, version ',a4,' (',a8,')')
                                                                end if

                                                                if (ucode(1:5).eq.'EQ3NR' .or. ucode(1:5).eq.'eq3nr') then
                                                                    write (newin,2190) urelno,ustage,ueqlrn,ueqlst
2190 format('* pickup file written by EQ3NR, version ',a4,' (',a8,')',/'*  supported by EQLIB, version ',a4,' (',a8,')')
                                                                end if
