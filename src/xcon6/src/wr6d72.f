      subroutine wr6d72(cdac,cesrb,csigma,dlzmx1,dlzmx2,dlzidp,
...
c
     ...
     $ kxt,newin,nffg,nmodl1,nmodl2,nordlm,npslmx,nprmn,nprmx,nrct,
     $ nsslmx,ntitl1,ntitl2,ntrymx,nxmod,nxopex,nxopt
c
...
c
 ...
 1290     format('| REACTANT',t20,'| ',a24,t47,'|status',t57,'|',i2,
     $    t72,'|')
          write (newin,1300) morr(nrc),modr(nrc)
 1300     format('| moles remaining',t20,'|',1pg12.5,t47,'|destroyed',
     $    t57,'|',1pg12.5,t72,'|')
          write (newin,1310) umint(jcode(nrc)),sk(nrc)
 1310     format('| reactant type',t20,'|',2x,a14,t47,'|sk',t57,'|',
     $    1pg12.5,t72,'|')
          write (newin,1320) nsk(nrc),fk(nrc)
 1320     format('| surface type',t20,'|',2x,i2,t47,'|fk',t57,
     $    '|',1pg12.5,t72,'|')
c
...
c
 ...
 1330         format('| end-member',t20,'| ',a24,t47,
     $        '|mole fr',t57,'|',1pg12.5,t72,'|ss,n')
  170       continue
  180       if (iktbt(nxrt) .eq. 0) write (newin,1330) unone,zero
          else
            write (newin,1340)
 1340       format('| end-member',t20,'|',t47,'|mole fr',t57,'|',
     $       t72,'|ss,n')
          endif
c
...
c
 ...
 1360         format('| element',t20,'| ',a8,t35,'|moles',t47,'|',
     $        1x,1pe22.15,t72,'|sp,n')
  190       continue
  200       if (nesrbt(nsrt) .eq. 0) write (newin,1360) unone(1:8),zero
          else
            write (newin,1370)
 1370       format('| volume',t20,'|',t47,'|',t57,'|',t72,'|sp',
     $      /'| element',t20,'|',t47,'|moles',t57,'|',t72,'|sp,n')
          endif
c
...
c
 ...
 3000   format('c pickup file written by EQ6, version ',a4,' (',a8,')',
     $  t72,'|',/'c  supported by EQLIB, version ',a4,' (',a8,')',
     $  t72,'|')
      endif
c
      if (ucode(1:5).eq.'EQ3NR' .or. ucode(1:5).eq.'eq3nr') then
        write (newin,3005) urelno,ustage,ueqlrn,ueqlst
 3005   format('c pickup file written by EQ3NR, version ',a4,' (',a8,
     $  ')',t72,'|',/'c  supported by EQLIB, version ',a4,' (',a8,')',
     $  t72,'|')
      endif
c
