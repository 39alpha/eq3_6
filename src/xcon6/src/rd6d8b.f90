...
3000 format(/' * Error - (XCON6/rd6d8b) The dimensioning parameter',' for the',/7x,'number of iodb debugging print option switches',' with string definitions',/7x,'(ndbxpa) has a value of ',i3,', but the dimensioning',/7x,'parameter for the number',' of such switches (nodbpa) has a',/7x,'value of ',i3,'.')
...
3010 format(/' * Error - (XCON6/rd6d8b) The dimensioning parameter',' for the',/7x,'number of iopg activity coefficient option',' switches with string definitions',/7x,'(npgxpa) has a value',' of ' ,i3,', but the dimensioning',/7x,'parameter for the',' number of such switches (nopgpa) has a',/7x,'value of ',i3,'.')
...
3020 format(/' * Error - (XCON6/rd6d8b) The dimensioning parameter',' for the',/7x,'number of iopr print option switches',' with string definitions',/7x,'(nprxpa) has a value of ',i3,', but the dimensioning',/7x,'parameter for the number',' of such switches (noprpa) has a',/7x,'value of ',i3,'.')
...
3030 format(/' * Error - (XCON6/rd6d8b) The dimensioning parameter',' for the',/7x,'number of iopt model option switches',' with string definitions',/7x,'(nptxpa) has a value of ',i3,', but the dimensioning',/7x,'parameter for the number',' of such switches (noptpa) has a',/7x,'value of ',i3,'.')
...
1010 format(/' * Error - (XCON6/rd6d8b) The first line of a "D"',' format INPUT file',/7x,'should be a separator line;',' therefore, it should begin with',/7x,'"|-------". The first',' line begins instead with',/7x,'"',a,'".')
...
1015 format(/' * Error - (XCON6/rd6d8b) Have too many lines in',/7x,'the main title. The code is only dimensioned for ',i4,/7x,'lines. Reduce the size of the main title or increase',/7x,'the dimensioning parameter ntitpa.')
...
1020 format(/' * Error - (XCON6/rd6d8b) Was expecting to find a',' line beginning with',/7x,'"',a,'", instead found one',' beginning with',/7x,'"',a,'".')
...
1022 format(/' * Error - (XCON6/rd6d8b) Was expecting to find an',/7x,'option check box "[ ]" in the line beginning with',/7x,'"',a,'".')
...
1023 format(/' * Warning - (XCON6/rd6d8b) No option was selected for',/7x,'the temperature. The temperature will be set at a fixed',' value',/7x,'of ',f7.2,'C.')
...
1024 format(/' * Warning - (XCON6/rd6d8b) Multiple options were',' selected for',/7x,'the temperature. The temperature will be',' set at a fixed value',/7x,'of ',f7.2,'C.')
...
1030 format(/' * Warning - (XCON6/rd6d8b) No option was selected',' for the pressure.',/7x,'The pressure will be set to be in',' accord with the',/7x,'data file reference pressure curve.')
        ...
        write (nttyo,1026)
1026 format(/' * Warning - (XCON6/rd6d8b) Multiple options were',' selected for',/7x,'the pressure. The pressure will be set',' to be in accord with the',/7x,'data file reference pressure',' curve.')
...
1520 format(/' * Error - (XCON6/rd6d8b) Have too many reactants',/7x,'The code is only dimensioned for ',i4,' reactants.',/7x,'Reduce the number of reactants or increase the',/7x,'dimensioning parameter nrctpa.')
...
1060 format(/" * Error - (XCON6/rd6d8b) Don't recognize the",' jcode option string',/7x,' "',a,'". This should',' be one of the strings',/7x,'defined in the urcjco array.',' The valid strings are:',/)
...
1550 format(/' * Error - (XCON6/rd6d8b) Have too many solid',/7x,'solution reactants. The code is only dimensioned',/7x,'for ',i4,' such reactants. Reduce the number of',/7x,'such reactants or increase the dimensioning',' parameter nxrtpa.')
...
1590 format(/' * Error - (XCON6/rd6d8b) Have too many',' end-members',/7x,'in the solid solution reactant',a,'.',/7x,'The code is only dimensioned for ',i4,' end-members per',/7x,'solid solution. Reduce',' the number of end-members or',/7x,'increase the dimensioning parameter iktpar.')
...
1600 format(/' * Error - (XCON6/rd6d8b) Have too many special',/7x,'reactants. The code is only dimensioned for ',i4,/7x,'such reactants. Reduce the number of such reactants',/7x,'or increase the dimensioning parameter nsrtpa.')
...
1660 format(/' * Error - (XCON6/rd6d8b) Have too many','  chemical',/7x,'elements in the special reactant ',a,'.',/7x,'The code is only dimensioned for ',i4,' elements.',/7x,'Reduce the number of elements or',' increase the',/7x,'dimensioning parameter nctpar.')
...
1700 format(/' * Error - (XCON6/rd6d8b) Have too many basis',' basis species in the',/7x,'in the reaction for the',' special reactant ',a,'.',/7x,'The code is only',' dimensioned for ',i4,' basis species. Increase',/7x,'the dimensioning parameter nbtpar.')
...
1710 format(/' * Error - (XCON6/rd6d8b) Have too many generic',' ion exchanger',/7x,'reactants. The code is only',' dimensioned for ',i4,' such reactants.',/7x,'Reduce',' the number of such reactants or increase the',/7x,'dimensioning parameter nertpa.')
...
1716 format(/' * Error - (XCON6/rd6d8b) Have too many',' exchange sites',/7x,'in the generic ion exchanger',' reactant ',a,'.',/7x,'The code is only dimensioned',' for ',i4,' exchange sites per',/7x,'generic ion',' exchanger. Reduce the number of exchange sites or',/7x,'increase the dimensioning parameter jetpar.')
...
1724 format(/' * Error - (XCON6/rd6d8b) Have too many',' species on exchange',/7x,'site ',a,' of the generic',' ion exchanger reactant',/7x,a,'. The code is only',' dimensioned for species per',/7x,'exchange site.',' Reduce the number of end-members or increase',/7x,'the dimensioning parameter netpar.')
...
234 continue
        ...
        ! (ssfcar(n), cm2/g) from a two-line header.
        uheadx = '->'
        nfldtx = 4
        call rdd2lh(nfldmx,nfldt,nfldtx,ninpts,nlchmx,nttyo,qrderr,ufield,uheadr,uheadx,uline1,uline2,ulscr)
...
1033 format(/' * Warning - (XCON6/rd6d8b) No option was selected',' for the',/7x,'surface area of the reactant ',a,'. The',/7x,'surface area and specific surface area will each be set',/7x,'to zero.')
...
1035 format(/' * Warning - (XCON6/rd6d8b) Multiple options were',' selected for',/7x,'the surface area of the reactant ',a,'. The',/7x,'surface area will be set to a fixed value of ',1pe10.3,' cm3.')
...
1075 format(/" * Error - (XCON6/rd6d8b) Don't recognize the",' rate law option string',/7x,' "',a,'". This should',' be one of the strings',/7x,'defined in the urcnrk array.',' The valid strings are:',/)
...
1960 format(/' * Error - (XCON6/rd6d8b) Have too many rate',/7x,'constants or corresponding mechanisms in the ',a,/7x,'rate law for reactant ',a,'. The code is only',/7x,'dimensioned for ',i2,' rate constants per rate law.',/7x,'Reduce the number of rate constants or increase the',/7x,'dimensioning parameter imchpa.')
...
1080 format(/" * Error - (XCON6/rd6d8b) Have an incorrect",' relative rate law header',/7x,'"',a,'".',' Was expecting the string "',a,'".')
...
1958 format(/' * Error - (XCON6/rd6d8b) Have no',' "mechanisms" specified in the ',a,/7x,'rate law for reactant ',a,'.')
...
1118 format(/' * Warning - (XCON6/rd6d8b) No option was',' selected for',/7x,'treating the temperature',' dependence of the ',a,' rate constant',/7x,'for',' term ',i2,' of the rate equation for the reactant',' ',a,'.',/7x,'The temperature dependence will be',' set to zero.')
                        else
                            write (nttyo,1120) ux8(1:j2),imh,ureac(nrc)(1:j3)
1120 format(/' * Warning - (XCON6/rd6d8b) Multiple option','s were selected for',/7x,'treating the temperature',' dependence of the ',a,' rate constant',/7x,'for',' term ',i2,' of the rate equation for the reactant',' ',a,'.',/7x,'The temperature dependence will be',' set to zero.')
                        end if
...
1130 format(/' * Error - (XCON6/rd6d8b) Have too many',/7x,'species in the activity product in term ',i2,/7x,'of the ',a,' direction rate law for reactant',/7x,a,'. The code is only dimensioned for ',i3,/7x,'such species. Reduce the number of such species',/7x,'or increase the dimensioning parameter ndctpa.')
...
175 continue
                ...
                ! Linear rate law.
                ! Loop on mechanism. However, only one "mechanism" is
                ! allowed.
                imh = 0
...
1964 format(/' * Error - (XCON6/rd6d8b) Have more than the',' allowed one "mechanism"',/7x,'in the ',a,' rate','law for reactant ',a,'.')
...
1952 format(/' * Error - (XCON6/rd6d8b) Programming error trap:',' The ',a,/7x,'rate law code has an unrecognized value',' of ',i2,' for reactant',/7x,a,'.')
...
1607 format(/' * Error - (XCON6/rd6d8b) The iopt option switch',' title line',/7x,'"',a,'"',/7x,'read from the'," INPUT file isn't in the required format.")
...
1610 format(/' * Error - (XCON6/rd6d8b) The iopt option switch',' title line',/7x,'"',a,'"',/7x,'read from the',' INPUT file references an option switch index',/7x,'of ',i3,', which is out of range.')
...
1612 format(/' * Error - (XCON6/rd6d8b) The iopt option switch',' title string',/7x,'"',a,'"',/7x,"read from the INPUT file doesn't contain the",' matching defined string',/7x,'"',a,'".')
...
1630 format(/' * Error - (XCON6/rd6d8b) Have too many option',/7x,'choice lines for the iopt option switch whose title',' string is',/7x,'"',a,'".',/7x,' The code is only',' dimensioned for ',i3,' such lines. Reduce the',/7x,'number of such lines or increase the dimensioning',' parameter jptxpa.')
...
1640 format(/' * Error - (XCON6/rd6d8b) The following iopt',/7x,'option switch choice line read from the INPUT file',/7x,"isn't in the required format:",/7x,'"',a,'"')
...
1650 format(/' * Error - (XCON6/rd6d8b) The iopt option switch',/7x,'choice line',/7x,'"',a,'"',/7x,'read from the INPUT file references an out-of-range',' option',/7x,'choice index.')
...
1662 format(/' * Error - (XCON6/rd6d8b) The iopt option switch',' choice line',/7x,'"',a,'"',/7x," read from the INPUT file doesn't contain the",' matching defined string',/7x,'"',a,'".',/7x,'This line belongs to the option switch whose title',' string is',/7x,'"',a,'".')
...
1670 format(/" * Error - (XCON6/rd6d8b) Don't recognize the",' string "',a,'"',/7x,'that appears on the iopt',' option switch choice line',/7x,'"',a,'"',/7x,'read from the INPUT file. An option choice should',' be chosen by',/7x,'placing a "*", "x", or "X" in the',' checkbox ("[ ]"). This',/7x,'choice line belongs to',' the option switch whose title string is',/7x,'"',a,'".')
...
1680 format(/' * Warning - (XCON6/rd6d8b) No option choice was',' checked on the INPUT file',/7x,'for the iopt option',' switch whose title string is',/7x,'"',a,'".')
...
1694 format(/' * Warning - (XCON6/rd6d8b) More than one option',' choice was checked',/7x,'on the INPUT file for the iopt',' option switch whose title string is',/7x,'"',a,'".',/7x,'The last choice checked will be used. The',' matching string is',/7x,'"',a,'".')
        end if
    end do
...
1800 format(/' * Error - (XCON6/rd6d8b) The iopr option switch',' title line',/7x,'"',a,'"',/7x,'read from the'," INPUT file isn't in the required format.")
...
1810 format(/' * Error - (XCON6/rd6d8b) The iopr option switch',' title line',/7x,'"',a,'"',/7x,'read from the',' INPUT file references an option switch index',/7x,'of ',i3,', which is out of range.')
...
1812 format(/' * Error - (XCON6/rd6d8b) The iopr option switch',' title string',/7x,'"',a,'"',/7x,"read from the INPUT file doesn't contain the",' matching defined string',/7x,'"',a,'".')
...
1830 format(/' * Error - (XCON6/rd6d8b) Have too many option',/7x,'choice lines for the iopr option switch whose title',' string is',/7x,'"',a,'".',/7x,' The code is only',' dimensioned for ',i3,' such lines. Reduce the',/7x,'number of such lines or increase the dimensioning',' parameter jprxpa.')
...
1840 format(/' * Error - (XCON6/rd6d8b) The following iopr',/7x,'option switch choice line read from the INPUT file',/7x,"isn't in the required format:",/7x,'"',a,'"')
...
1850 format(/' * Error - (XCON6/rd6d8b) The iopr option switch',/7x,'choice line',/7x,'"',a,'"',/7x,'read from the INPUT file references an out-of-range',' option',/7x,'choice index.')
...
1860 format(/' * Error - (XCON6/rd6d8b) The iopr option switch',' choice line',/7x,'"',a,'"',/7x," read from the INPUT file doesn't contain the",' matching defined string',/7x,'"',a,'".',/7x,'This line belongs to the option switch whose title',' string is',/7x,'"',a,'".')
...
1870 format(/" * Error - (XCON6/rd6d8b) Don't recognize the",' string "',a,'"',/7x,'that appears on the iopr',' option switch choice line',/7x,'"',a,'"',/7x,'read from the INPUT file. An option choice should',' be chosen by',/7x,'placing a "*", "x", or "X" in the',' checkbox ("[ ]"). This',/7x,'choice line belongs to',' the option switch whose title string is',/7x,'"',a,'".')
...
1880 format(/' * Warning - (XCON6/rd6d8b) No option choice was',' checked on the INPUT file',/7x,'for the iopr option',' switch whose title string is',/7x,'"',a,'".')
...
1894 format(/' * Warning - (XCON6/rd6d8b) More than one option',' choice was checked',/7x,'on the INPUT file for the iopr',' option switch whose title string is',/7x,'"',a,'".',/7x,'The last choice checked will be used. The',' matching string is',/7x,'"',a,'".')
        end if
    end do
...
1900 format(/' * Error - (XCON6/rd6d8b) The iodb option switch',' title line',/7x,'"',a,'"',/7x,'read from the'," INPUT file isn't in the required format.")
...
1910 format(/' * Error - (XCON6/rd6d8b) The iodb option switch',' title line',/7x,'"',a,'"',/7x,'read from the',' INPUT file references an option switch index',/7x,'of ',i3,', which is out of range.')
...
1920 format(/' * Error - (XCON6/rd6d8b) The iodb option switch',' title string',/7x,'"',a,'"',/7x,"read from the INPUT file doesn't contain the",' matching defined string',/7x,'"',a,'".')
...
1922 format(/' * Error - (XCON6/rd6d8b) Have too many option',/7x,'choice lines for the iodb option switch whose title',' string is',/7x,'"',a,'".',/7x,' The code is only',' dimensioned for ',i3,' such lines. Reduce the',/7x,'number of such lines or increase the dimensioning',' parameter jdbxpa.')
...
1940 format(/' * Error - (XCON6/rd6d8b) The following iodb',/7x,'option switch choice line read from the INPUT file',/7x,"isn't in the required format:",/7x,'"',a,'"')
...
1950 format(/' * Error - (XCON6/rd6d8b) The iodb option switch',/7x,'choice line',/7x,'"',a,'"',/7x,'read from the INPUT file references an out-of-range',' option',/7x,'choice index.')
...
1962 format(/' * Error - (XCON6/rd6d8b) The iodb option switch',' choice line',/7x,'"',a,'"',/7x," read from the INPUT file doesn't contain the",' matching defined string',/7x,'"',a,'".',/7x,'This line belongs to the option switch whose title',' string is',/7x,'"',a,'".')
...
1970 format(/" * Error - (XCON6/rd6d8b) Don't recognize the",' string "',a,'"',/7x,'that appears on the iodb',' option switch choice line',/7x,'"',a,'"',/7x,'read from the INPUT file. An option choice should',' be chosen by',/7x,'placing a "*", "x", or "X" in the',' checkbox ("[ ]"). This',/7x,'choice line belongs to',' the option switch whose title string is',/7x,'"',a,'".')
...
1980 format(/' * Warning - (XCON6/rd6d8b) No option choice was',' checked on the INPUT file',/7x,'for the iodb option',' switch whose title string is',/7x,'"',a,'".')
...
1994 format(/' * Warning - (XCON6/rd6d8b) More than one option',' choice was checked',/7x,'on the INPUT file for the iodb',' option switch whose title string is',/7x,'"',a,'".',/7x,'The last choice checked will be used. The',' matching string is',/7x,'"',a,'".')
        end if
    end do
...
1320 format(/' * Error - (XCON6/rd6d8b) Have too many mineral',/7x,'subset-selection suppression options. The code is',/7x,'only dimensioned for ',i3,' such options. Reduce the',/7x,'number of options or increase the dimensioning',/7x,'parameter nxoppa.')
...
3060 format(/" * Error - (XCON6/rd6d8b) Don't recognize the",' uxopt option string',/7x,'"',a,'". This should',' be one of the strings',/7x,'defined in the uxopti array.',' The valid strings are:',/)
...
1370 format(/' * Error - (XCON6/rd6d8b) Have too many',/7x,'exceptions specified to the mineral subset-selection',/7x,'suppression options. The code is only dimensioned',/7x,'for ',i3,'exceptions. Reduce the number of exceptions',/7x,'or increase the dimensioning parameter nxpepa.')
...
1420 format(/' * Error - (XCON6/rd6d8b) Have too many gases whose',' fugacities are to be fixed.',/7x,'The code is only',' dimensioned for ',i4,' such gases. Reduce the number',/7x,'of gases or increase the dimensioning parameter nffgpa.')
...
5015 format(/' * Error - (XCON6/rd6d8b) Have too many lines in',/7x,'the secondary title. The code is only dimensioned for ',i4,/7x,'lines. Reduce the size of the secondary title or ','increase',/7x,'the dimensioning parameter ntitpa.')
...
1620 format(/' * Error - (XCON6/rd6d8b) Have exceeded the',' maximum number of ',i3,/7x,'generic ion exchange phases',' while reading the data to create',/7x,'such phases.',' Increase the dimensioning parameter netpar',/7x,'to at',' least ',i3,'.')
        ...
        if (ustr24(1:8) .ne. uheadx(1:8)) then
            ...
            j2 = min(j2,70)
            write (nttyo,1070) uline1(1:j2)
1070 format(/' * Error - (XCON6/rd6d8b) Read the following line',' where a separator line',/7x,'("|------- ... -------|")',' was expected:',/7x,'"',a,'".')
            ...
            if (ustr(1:j2) .eq. uheadx(1:j3)) then
                ...
                if (qokay) then
                    ...
                    if (je .gt. jetmax) then
                        j2 = ilnobl(ugexp(ne))
                        write (nttyo,1220) jetmax,ugexp(ne)(1:j2),je
1220 format(/' * Error - (XCON6/rd6d8b) Have exceeded the',' maximum number of ',i3,/7x,'exchange sites on a',' generic ion exchange phase while reading',/7x,'the',' data to create ',a,'. Increase the',/7x,'dimensioning parameter jetpar to at least ',i3,'.')
...
1820 format(/' * Error - (XCON6/rd6d8b) Have exceeded the',' maximum number of ',i3,/7x,'reactions for a site',' belonging to a generic ion exchange',/7x,'phase',' while reading the data for site ',a,' of exchange',' phase',/7x,a,'. Increase the dimensioning',' parameter',/7x,'ietpar to at least ',i3,'.')
...
1500 format(/' * Error - (XCON6/rd6d8b) Have too many nxmod',/7x,'alter/suppress options. The code is only dimensioned',/7x,'for ',i3,' such options. Reduce the number of such',/7x,'options or increase the dimensioning parameter nxmdpa.')
...
1510 format(/" * Error - (XCON6/rd6d8b) Don't recognize the",' alter/suppress option',/7x,'string "',a,'". This should',' be one of the strings',/7x,'defined in the ukxm array.',' The valid strings are:',/)
...
1705 format(/' * Error - (XCON6/rd6d8b) The iopg option switch',' title line',/7x,'"',a,'"',/7x,'read from the'," INPUT file isn't in the required format.")
...
1712 format(/' * Error - (XCON6/rd6d8b) The iopg option switch',' title line',/7x,'"',a,'"',/7x,'read from the',' INPUT file references an option switch index',/7x,'of ',i3,', which is out of range.')
...
1720 format(/' * Error - (XCON6/rd6d8b) The iopg option switch',' title string',/7x,'"',a,'"',/7x,"read from the INPUT file doesn't contain the",' matching defined string',/7x,'"',a,'".')
...
1730 format(/' * Error - (XCON6/rd6d8b) Have too many option',/7x,'choice lines for the iopg option switch whose title',' string is',/7x,'"',a,'".',/7x,' The code is only',' dimensioned for ',i3,' such lines. Reduce the',/7x,'number of such lines or increase the dimensioning',' parameter jpgxpa.')
...
1740 format(/' * Error - (XCON6/rd6d8b) The following iopg',/7x,'option switch choice line read from the INPUT file',/7x,"isn't in the required format:",/7x,'"',a,'"')
...
1750 format(/' * Error - (XCON6/rd6d8b) The iopg option switch',/7x,'choice line',/7x,'"',a,'"',/7x,'read from the INPUT file references an out-of-range',' option',/7x,'choice index.')
...
1760 format(/' * Error - (XCON6/rd6d8b) The iopg option switch',' choice line',/7x,'"',a,'"',/7x," read from the INPUT file doesn't contain the",' matching defined string',/7x,'"',a,'".',/7x,'This line belongs to the option switch whose title',' string is',/7x,'"',a,'".')
...
1770 format(/" * Error - (XCON6/rd6d8b) Don't recognize the",' string "',a,'"',/7x,'that appears on the iopg',' option switch choice line',/7x,'"',a,'"',/7x,'read from the INPUT file. An option choice should',' be chosen by',/7x,'placing a "*", "x", or "X" in the',' checkbox ("[ ]"). This',/7x,'choice line belongs to',' the option switch whose title string is',/7x,'"',a,'".')
...
1780 format(/' * Warning - (XCON6/rd6d8b) No option choice was',' checked on the INPUT file',/7x,'for the iopg option',' switch whose title string is',/7x,'"',a,'".')
...
1794 format(/' * Warning - (XCON6/rd6d8b) More than one option',' choice was checked',/7x,'on the INPUT file for the iopg',' option switch whose title string is',/7x,'"',a,'".',/7x,'The last choice checked will be used. The',' matching string is',/7x,'"',a,'".')
        end if
    end do
...
3240 format(/' * Error - (XCON6/rd6d8b) Have too many chemical',/7x,'elements present. The code is only dimensioned',/7x,'for ',i3,' elements. Reduce the number of elements',/7x,'or increase the dimensioning parameter nctpar.')
...
3250 format(/' * Error - (XCON6/rd6d8b) Have too many basis',/7x,'species present. The code is only dimensioned',/7x,'for ',i3,' basis species. Reduce the number of elements',/7x,'or increase the dimensioning parameter nctpar.')
...
3260 format(/' * Error - (XCON6/rd6d8b) Have too many matrix',/7x,'variables. The code is only dimensioned for ',i3,/7x,'matrix variables. Reduce the number of such variables',/7x,'or increase the dimensioning parameter kpar.')
...
5010 format(/' * Error - (XCON6/rd6d8b) Found ',i2,' fields',' where ',i2,/7x,'were expected on the line which begins with',/7x,'"',a,'".')
...
5020 format(/' * Error - (XCON6/rd6d8b) The number of mass balance',' species read',/7x,'from the INPUT file exceeded the',' maximum of ',i3,' while',/7x,'trying to read data for',' the species ',a,'.',/7x,'Increase the dimensioning',' parameter nbtpar.')
...
5030 format(/" * Error - (XCON6/rd6d8b) Can't identify the",/7x,'following Mass-Balance-Species Units/constraints string- ',a,'.',/7x,'This must be one of "Moles", or "Make non-basis".')
...
5040 format(/' * Error - (XCON6/rd6d8b) Found that the mass',' balance species name',/7x,'"',a,'".',/7x,"doesn't match",' the mass balance totals species name tag',/7x,'"',a,'"',/7x,'(which has a maximum length of only 32 characters).')
...
5050 format(/' * Error - (XCON6/rd6d8b) The number of matrix',' column variables',/7x,'and values read from the INPUT file',' exceeded the maximum',/7x,'of ',i3,' while trying to read',' data for the basis species',/7x,a,'. Increase the',' dimensioning parameter kmax.')
...
3640 format(/' * Error - (XCON6/rd6d8b) Have too many phases',/7x,'in the physically removed system (PRS) on the',/7x,'INPUT file. The code is only dimensioned for ',i3,/7x,'such phases. Reduce the number of such phases',/7x,'or increase the dimensioning parameter nprppa.')
...
3680 format(/' * Error - (XCON6/rd6d8b) Have too many',' end-members',/7x,'in the PRS solid solution ',a,'.',/7x,'The code is only dimensioned for ',i4,' end-members per',/7x,'solid solution. Reduce',' the number of end-members or',/7x,'increase the dimensioning parameter iktpar.')
...
2000 format(/' * Error - (XCON6/rd6d8b) Have exceeded the',' maximum number of ',i3,/7x,'species while reading',' the data for phases and species in the PRS',/7x,' Increase the dimensioning parameter',' nprsmx to at least ',i3,'.')
