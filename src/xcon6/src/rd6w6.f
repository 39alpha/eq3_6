      subroutine rd6w6(cdac,cesrb,cplim,csigma,dlzmx1,dlzmx2,dlzidp,
...
c     for version 6 (versions 6.0-6.1).
c
...
c
      integer iktbt(nxrtmx),imech(2,nrctmx),iodb(nodbmx),iopg(nopgmx),
     $ iopr(noprmx),iopt(noptmx),jcode(nrctmx),jreac(nrctmx),
     $ jxmod(nxmdmx),kxmod(nxmdmx),ndact(imchmx,2,nrctmx),
     $ nesrbt(nsrtmx),nrk(2,nrctmx),nsk(nrctmx)
c
...
c
     ...
     $ csigma(imchmx,2,nrctmx),fk(nrctmx),modr(nrctmx),moffg(nffgmx),
     $ morr(nrctmx),mprs(nprsmx),mteaqb(nctmax),mteb(nctmax),
     $ rk0(imchmx,2,nrctmx),rxbarb(iktmax,nxrtmx),sscrew(nsscmx),
     $ sk(nrctmx),ttk(nttkmx),vreac(nrctmx),xlkffg(nffgmx),
...
c
 ...
 1015   format(/' * Error - (XCON6/rd6w6) Have too many lines in the',
...
c
 ...
 1315   format(/' * Error - (XCON6/rd6w6) Have too many mineral',
...
c
 ...
 1345     format(/' * Error - (XCON6/rd6w6) Have too many',
...
c
 ...
 1385   format(/' * Error - (XCON6/rd6w6) Have too many gases whose',
...
c
 ...
 1425   format(/' * Error - (XCON6/rd6w6) Have too many reactants',
...
c
 ...
 1445         format(/' * Error - (XCON6/rd6w6) Have too many solid',
...
c
 ...
 1446           format(/' * Error - (XCON6/rd6w6) Have too many',
...
c
 ...
 1447         format(/' * Error - (XCON6/rd6w6) Have too many special',
...
c
 ...
 1510           format(/' * Error - (XCON6/rd6w6) Have too many',
     $          '  chemical',
...
c
 ...
 1550         format(/' * Error - (XCON6/rd6w6) Have too many rate',
...
c
 ...
 1655           format(/' * Error - (XCON6/rd6w6) Have too many',
...
c
 ...
 1673         format(/' * Error - (XCON6/rd6w6) Have too many rate',
...
c
 ...
 1675           format(/' * Error - (XCON6/rd6w6) Have too many',
     $          /7x,'species in the activity product in term ',i2,
...
c
 ...
 3002   format(/' * Error - (XCON6/rd6w6) Have too many lines in the',
...
c-----------------------------------------------------------------------
c
c     Ion to define equivalent stoichiometric ionic strength.
c
...
c
 ...
 3035   format(/' * Error - (XCON6/rd6w6) Have too many nxmod',
...
c
 ...
 3095   format(/' * Error - (XCON6/rd6w6) Have too many chemical',
...
c
 ...
 3100   format(/' * Error - (XCON6/rd6w6) Have too many master',
...
c
 ...
 3190       format(/' * Error - (XCON6/rd6w6) Have too many mineral',
