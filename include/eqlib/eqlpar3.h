...
parameter(imch_par = 4,ndct_par = 4,nert_par = 40,nffg_par = 20,nprp_par = 100,nptk_par = 3,nrct_par = 40,nsrt_par = 40,nttk_par = 3,nxop_par = 40,nxpe_par = 100,nxrt_par = 40)
