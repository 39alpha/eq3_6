...
data uopt6(2)   / 'LOADING OF SPECIES INTO MEMORY                  ' /
data uvar6(2)     / 'iopr'  /
data index6(2)   / 1 /
...
data uopt6(3)  / 'LIST DERIVATIVES OF BASIS ELEMENTS AT EACH PRINT POINT' /
data uvar6(3)     / 'iopr' /
data index6(3)   / 2 /
...
data uopt6(4) / 'LIST ALL SPECIES LOADED INTO MEMORY AND THEIR LOG K VALUES' /
data uvar6(4)     / 'iopr' /
data index6(4)   / 3 /
...
data uopt6(5)   / 'LIST DISTRIBUTION OF AQUEOUS SPECIES AT EACH PRINT POINT' /
data uvar6(5)      / 'iopr' /
data index6(5)     / 4 /
...
data uopt6(6)     / 'LIST CATION/H+ ACTIVITY RATIOS AT EACH PRINT POINT' /
data uvar6(6)      / 'iopr' /
data index6(6)    / 5 /
...
data uopt6(7) / 'LIST BULK ELEMENT AND OXIDE COMPOSITION AT EACH PRINT POINT'/
data uvar6(7)      / 'iopr' /
data index6(7)    / 6 /
...
data uopt6(9)   / 'LIST GAS SPECIES SUMMARY AT EACH PRINT POINT' /
data uvar6(9)      / 'iopr' /
data index6(9)    / 8 /
...
data uopt6(10)   / 'PRINT AQUEOUS MASS AND CONCENTRATION TOTALS' /
data uvar6(10)    / 'iopr' /
data index6(10)   / 11 /
...
data iopti6(27)   / 12 /
data ivalu6(27)   / -1 /
data udesc6(28)   / 'write pickup file for each print point' /
data iopti6(28)   / 12 /
data ivalu6(28)   / 1  /
...
data iopti6(29)   / 13 /
data ivalu6(29)   / 0 /
data udesc6(30)  / 'transfer minerals but leave trivial mass in the system' /
data iopti6(30)   / 13 /
data ivalu6(30)   / 1 /
data udesc6(31)  / 'transfer minerals' /
data iopti6(31)   / 13 /
data ivalu6(31)   / 2 /
...
data iopti6(32)   / 14 /
data ivalu6(32)   / 0 /
data udesc6(33)       / 'clear p.r.s. before first reaction progress advance' /
data iopti6(33)   / 14 /
data ivalu6(33)   / 1 /
...
data uvar6(15)     / 'iopt' /
data index6(15)   / 2 /
data udesc6(34)  / 'step size constrained by predicted phase boundaries' /
data iopti6(34)   / 15 /
data ivalu6(34)   / 0  /
data udesc6(35) /"phase boundaries estimated from Taylor's series and printed"/
data iopti6(35)   / 15 /
data ivalu6(35)   / 1 /
...
data uvar6(18)     / 'iopt' /
data index6(18)   / 8      /
data udesc6(41)   / 'linear for kcol = 1,kdim, logarithmic for kcol = 1,kbt' /
data iopti6(41)   / 18    /
data ivalu6(41)   / 0      /
...
data uopt6(20)/ 'PRINT MEAN MOLAL ACTIVITY COEFFICIENTS FOR DISSOLVED SPECIES'/
data uvar6(20)     / 'iopr' /
data index6(20)   / 9      /
...
data iopti6(48)   / 21     /
data ivalu6(48)   / 0      /
data udesc6(49)   / 'print species in model and number of Pitzer coefficients' /
data iopti6(49)   / 21     /
data ivalu6(49)   / 1      /
data udesc6(50)   / 'print species in model and names of Pitzer coefficients' /
data iopti6(50)   / 21     /
data ivalu6(50)   / 2      /
...
data iopti6(60)   / 25    /
data ivalu6(60)   / 0      /
data udesc6(61)          / 'print step size and order when delzi .le. dlzmx1' /
data iopti6(61)   / 25     /
data ivalu6(61)   / 1      /
...
data iopti6(63)   / 26     /
data ivalu6(63)   / 1      /
data udesc6(64)   / 'print summary, residual functions and correction terms' /
data iopti6(64)   / 26    /
data ivalu6(64)   / 2     /
data udesc6(65)/'print summary, residual functions, correction terms and matrix'/
data iopti6(65)   / 26     /
data ivalu6(65)   / 4      /
...
data iopti6(71)   / 29     /
data ivalu6(71)   / 1      /
data udesc6(72)   / 'print computations from RDERIV, RTAYLR, DERIV and TAYLOR' /
data iopti6(72)   / 29     /
data ivalu6(72)   / 2      /
...
data uopt6(32)      / 'KILL ITERATION VARIABLES'/
data uvar6(32)     / 'iodb' /
data index6(32)    / 12     /
...
data udevl6(1)  / 'check finite difference and Taylor series expression' /
data udv6vr(1)  / 'iodb' /
data idev6i(1)  / 10 /

data udevl6(2)  /'check reaction rate finite difference and Taylor series' /
data udv6vr(2)  / 'iodb' /
data idev6i(2)  / 11 /
