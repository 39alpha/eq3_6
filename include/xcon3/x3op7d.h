...
!      VALIDATION VALUES FOR THE VARIABLE cspb                         *
...
data iopti3(2)   / 1 /
data ivalu3(2)   / 1 /
data udesc3(3)        / 'process input and hypothetical solid solutions'/
data iopti3(3)  / 1 /
data ivalu3(3)  / 2 /

data uopt3(2)   / 'LOADING OF SPECIES INTO MEMORY                  ' /
data uvar3(2)     / 'iopr'  /
data index3(2)   / 1 /
...
data iopti3(8)   / 3 /
data ivalu3(8)   / 2 /
data udesc3(9)           / 'lists reactions, log K values and polynomial coef.'/
data iopti3(9)   / 3 /
data ivalu3(9)   / 3 /
...
data uopt3(5)            / 'LIST OF AQUEOUS SPECIES (concentration limit)' /
data uvar3(5)      / 'iopr' /
data index3(5)    / 4 /
...
data iopti3(30)   / 11 /
data ivalu3(30)   / 0 /
data udesc3(31)  / 'print species in model and number of Pitzer coefficients' /
data iopti3(31)   / 11 /
data ivalu3(31)   / 1 /
data udesc3(32)  / 'print species in model and names of Pitzer coefficients' /
data iopti3(32)   / 11 /
data ivalu3(32)   / 2 /
...
data uopt3(14)  / 'LIST AQUEOUS SPECIES, ION SIZES, AND HYDRATION NUMBERS'/
data uvar3(14)    / 'iopr' /
data index3(14)   /  8  /
...
data uvar3(15)    / 'iopt' /
data index3(15)   / 6      /
data udesc3(39)   / 'test both residual functions and correction terms' /
data iopti3(39)   / 15     /
data ivalu3(39)   / 0      /
...
data udebug(2)   / 'print details of pre-Newton-Raphson iteration' /
data idbugi(2)  / 2 /
...
data udebug(5)   /'print details of stoichiometric factors calculation' /
data idbugi(5)  / 6 /

data udebug(6)  /'write reactions on RLIST'   /
data idbugi(6)  / 7 /

data udebug(7)   /'list stoichiometric concentrations of master species' /
data idbugi(7)  / 10 /
